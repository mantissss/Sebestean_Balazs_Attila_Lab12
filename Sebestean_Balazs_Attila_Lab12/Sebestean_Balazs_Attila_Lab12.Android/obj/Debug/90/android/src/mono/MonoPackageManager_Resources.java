...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Sebestean_Balazs_Attila_Lab12.Android.dll" comes first in this list. */
		"Sebestean_Balazs_Attila_Lab12.Android.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
		"Sebestean_Balazs_Attila_Lab12.dll",
